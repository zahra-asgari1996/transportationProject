...
@WebServlet(name = "SaveNewDeliveyHistoryServlet")
public class SaveNewDeliveyHistoryServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session!=null){
            ...
            if (description!=null){
                service.saveNewDeliveryHistoryByEmployee(number,userName,description);
            }else{
                service.saveNewDeliveryHistoryByEmployee(number,userName);
            }
